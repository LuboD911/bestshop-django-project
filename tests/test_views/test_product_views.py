'''
Нямам няква специфична логика, че да тествам, но реших е така да направя 1-2 view test-a.
То като цяло и на другите не знаех какво да тества и реших да тествам само частта с валидаторите.
'''
